## Ejecución del 2026-08-25 12:23 — modo ESCRITURA

- **URL:** `http://localhost:4300/evaluacionempleado-prueba` (local, `ng serve --configuration prueba` → API `:7071`, BD `Evaluaciones_Test`)
- **Marca de la ejecución:** `[E2E-20260825121944]`
- **Resultado:** 11 paso(s) correctos, 0 parcial(es), 1 con problemas, 0 omitido(s) por entero, 1 problema(s), 0 error(es) de JavaScript en consola.
...
| 4 | Pestaña "Competencias por puesto": listado, semáforo, filtros y detalle | `05-tab-competencias-puesto.png`<br>`06-listado-puestos-semaforo-y-aviso.png`<br>`07-filtros-aplicados.png`<br>`08-detalle-puesto-con-competencias.png`<br>`09-filtro-solo-ocupados.png` | Con problemas — [Filtro] El filtro "solo ocupados" devuelve 1 puestos y la franja de resumen declara 90 puestos con empleados activos |
...
**4. Pestaña "Competencias por puesto": listado, semáforo, filtros y detalle** — _con problemas_
...
- Puestos vacíos con departamento válido (relectura fiable): 84; de ellos, sin empleados activos: 84
- Candidato ámbar para el paso 6: ADMINISTRADOR BASE DE DATOS (DBA) (#6, peso 99)
- Candidato para el alta múltiple: ABOGADA DE COBROS LEGAL (#92, departamento "CREDITO, LEGAL Y COBROS")
- ⚠️ [Filtro] El filtro "solo ocupados" devuelve 1 puestos y la franja de resumen declara 90 puestos con empleados activos
...
- Borradas 2; tras releer quedan 0 filas con la marca [E2E-20260825121944]
...
|---|---|---|---|
| 1 | 4 | Filtro | El filtro "solo ocupados" devuelve 1 puestos y la franja de resumen declara 90 puestos con empleados activos |
