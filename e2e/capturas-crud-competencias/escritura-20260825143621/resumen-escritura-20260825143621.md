...
| 10 | Pestaña "Ponderación": valores, bloqueo si no suma 100 y escritura sobre un periodo cerrado | `31-tab-ponderacion.png`<br>`32-ponderacion-suma-invalida.png`<br>`33-ponderacion-restaurada.png`<br>`34-ponderacion-periodo-cerrado.png`<br>`35-ponderacion-guardada-verificada.png`<br>`36-ponderacion-restaurada-verificada.png` | Correcto |
| 11 | Pestaña "Diagnóstico": tres listados, conteos y bloque de no verificables | `37-tab-diagnostico.png`<br>`38-diagnostico-advertencia-defecto-A.png`<br>`39-diagnostico-no-verificables.png`<br>`40-diagnostico-listados.png` | Correcto |
...
- Borradas 2; tras releer quedan 0 filas con la marca [E2E-20260825143621]
...
**10. Pestaña "Ponderación": valores, bloqueo si no suma 100 y escritura sobre un periodo cerrado** — _ok_
...
- Restaurado en pantalla: "check_circle Suma: 100 — correcto" (no se pulsó Guardar sobre el periodo activo)
- Periodo elegido para la prueba de escritura: "Evaluación de Desempeño Final 2024" (no activo)
- Valores originales de "Evaluación de Desempeño Final 2024": 30 / 70
- Guardado (valores nuevos) 40/60 → respuesta: "Ponderación Desempeño / Competencia La ponderación del periodo quedó guardada: 40% Desempeño / 60% Competencia (verificado releyendo del API). Cool"
- Tras releer del API: 40 / 60 (se pidió 40 / 60)
- La ponderación se guardó y la relectura del API lo confirma: 40 / 60. Criterio 5 ejercido de extremo a extremo.
- Guardado (restauración) 30/70 → respuesta: "Ponderación Desempeño / Competencia La ponderación del periodo quedó guardada: 30% Desempeño / 70% Competencia (verificado releyendo del API). Cool"
- Ponderación de "Evaluación de Desempeño Final 2024" restaurada a 30 / 70 y confirmada releyendo
- Shell devuelto al periodo activo: "Evaluación de Mitad de año 2026 — activo"
