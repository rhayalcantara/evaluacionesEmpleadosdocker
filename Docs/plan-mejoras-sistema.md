...
| T3.4 | No enviar "Bearer null" | [ ] | | |
| T4.1 | Anti doble-submit (formularios no vetados) | [ ] | | |
| T4.2 | Cierre garantizado de LoadingComponent | [ ] | | |
| T4.3 | CSS compartido + bajar de budget | [ ] | | |
| T5.1 | takeUntil en fugas confirmadas | [ ] | | |
| T5.2 | Barrido ngOnDestroy en Forms | [ ] | | |
| T5.3 | Refactor navmenu (callback hell) | [ ] | | |
| T5.4 | Fix N+1 en Empleados.ts | [ ] | | |
