...
window.PROGRESO = {
  actualizado: "2026-09-11 10:20 — F0 EN CURSO",
    ...
    { id: "F0", nombre: "Contratos y base (orquestador)", nota: "modelo EF, migración, tablas en Evaluaciones_Test, contratos TS, baterías adelantadas",
      tareas: [
        { id: "MOD", archivo: "API: Models/BitacoraEvento.cs, BitacoraEventoCompetencia.cs, DatosContext", estado: "integrado", ronda: 1,
          pruebas: "dotnet build 0 errores", tokens: null, commit: "", nota: "Índices por empleado+fecha y autor; unicidad evento+competencia; borrado lógico" },
        { id: "MIG", archivo: "API: Migrations/20260911120000_AddBitacoraEventos.cs + scripts/bitacora_crear_tablas.sql", estado: "integrado", ronda: 1,
          pruebas: "tablas creadas en Evaluaciones_Test; fila en __EFMigrationsHistory", tokens: null, commit: "", nota: "dotnet ef no arranca sin runtime .NET 7: migración escrita a mano, snapshot sin regenerar" },
        { id: "CON", archivo: "src/app/Models/Bitacora/IBitacora.ts", estado: "integrado", ronda: 1,
          pruebas: "—", tokens: null, commit: "", nota: "Tipos, catálogos, filtros, resumen por competencia y por empleado" },
        { id: "BAT", archivo: "tests/bitacora/test_api_bitacora.py", estado: "en curso", ronda: 1,
          pruebas: "pytest contra :7071 (se corre tras desplegar B1)", tokens: null, commit: "", nota: "El constructor nunca la ve" }
      ] },
