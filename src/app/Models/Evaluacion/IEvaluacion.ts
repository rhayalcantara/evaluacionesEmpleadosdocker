...
export interface IEvaluacion {
    ...
    colaboradorContinuar?: string;
    colaboradorHacerMas?: string;
    colaboradorHacerMenos?: string;
    colaboradorParar?: string;
    supervisorContinuar?: string;
    supervisorHacerMas?: string;
    supervisorHacerMenos?: string;
    supervisorParar?: string;
    colaboradorCompromisos?: string;
    supervisorCompromisos?: string;
  }
